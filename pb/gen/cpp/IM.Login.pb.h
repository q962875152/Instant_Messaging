...
inline std::string* IMMsgServRsp::release_prior_ip() {
  ...
  _has_bits_[0] &= ~0x00000001u;
  auto* p = prior_ip_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
...
inline std::string* IMMsgServRsp::release_backip_ip() {
  ...
  _has_bits_[0] &= ~0x00000002u;
  auto* p = backip_ip_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
...
inline std::string* IMLoginRes::release_result_string() {
  ...
  _has_bits_[0] &= ~0x00000001u;
  auto* p = result_string_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
...
inline std::string* IMRegistReq::release_avatar() {
  ...
  _has_bits_[0] &= ~0x00000008u;
  auto* p = avatar_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
