...
inline std::string* IMMsgServInfo::release_ip1() {
  ...
  _has_bits_[0] &= ~0x00000001u;
  auto* p = ip1_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
...
inline std::string* IMMsgServInfo::release_ip2() {
  ...
  _has_bits_[0] &= ~0x00000002u;
  auto* p = ip2_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
...
inline std::string* IMPushToUserReq::release_flash() {
  ...
  _has_bits_[0] &= ~0x00000001u;
  auto* p = flash_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
