...
class IMP2PCmdMsg final :
 ...
 public:
  ...
  IMP2PCmdMsg* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  PROTOBUF_NODISCARD std::string* release_cmd_msg_data();
...
inline uint32_t IMP2PCmdMsg::_internal_from_user_id() const {
  return from_user_id_;
}
inline uint32_t IMP2PCmdMsg::from_user_id() const {
  // @@protoc_insertion_point(field_get:IM.SwitchService.IMP2PCmdMsg.from_user_id)
  return _internal_from_user_id();
}
inline void IMP2PCmdMsg::_internal_set_from_user_id(uint32_t value) {
  _has_bits_[0] |= 0x00000002u;
  from_user_id_ = value;
}
inline void IMP2PCmdMsg::set_from_user_id(uint32_t value) {
...
inline uint32_t IMP2PCmdMsg::_internal_to_user_id() const {
  return to_user_id_;
}
inline uint32_t IMP2PCmdMsg::to_user_id() const {
  // @@protoc_insertion_point(field_get:IM.SwitchService.IMP2PCmdMsg.to_user_id)
  return _internal_to_user_id();
}
inline void IMP2PCmdMsg::_internal_set_to_user_id(uint32_t value) {
  _has_bits_[0] |= 0x00000004u;
  to_user_id_ = value;
}
inline void IMP2PCmdMsg::set_to_user_id(uint32_t value) {
...
inline std::string* IMP2PCmdMsg::release_cmd_msg_data() {
  ...
  _has_bits_[0] &= ~0x00000001u;
  auto* p = cmd_msg_data_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (cmd_msg_data_.IsDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited())) {
